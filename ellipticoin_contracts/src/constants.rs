...
pub const MS: Address = hex!("0000000000000000000000000000000000000002");
// pub const USD: Address = hex!("6d7f0754ffeb405d23c51ce938289d4835be3b14");
pub const C_DAI: Address = hex!("5d3a536E4D6DbD6114cc1Ead35777bAB948E3643");
pub const DAI: Address = hex!("6b175474e89094c44da98b954eedeac495271d0f");
...
pub const MINER_ALLOW_LIST: [Address; 2] = [
    hex!("0113713f91dd6a7c179a038e66e5919a9a0a9d1d"),
    hex!("418b993b7d17b45937ef4f69a06a3433cd30b5ce"),
];
pub const RATIFICATION_THRESHOLD: u64 = 26;
